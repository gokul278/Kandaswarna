    ...
    <>
      ...
      {scrolled && (
        <>
          ...
          >
            <div className="w-[80%]">
              <div className="w-[50px] bg-[#ff0b55] rounded-bl-[2px] rounded-br-[20px] flex justify-center items-center flex-col">
                <div style={{ fontFamily: "Poppins" }} className="font-bold font-Poppins text-[18px] text-white">
                  10
                </div>
                <div  style={{ fontFamily: "Poppins" }} className="font-[500] -mt-1 font-Poppins pb-2 text-[12px] text-white">
                  Years
                </div>
              </div>
            </div>
